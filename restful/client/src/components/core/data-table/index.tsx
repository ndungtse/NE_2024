...
import { ActionIcon, Button, Checkbox, Input, Table, TableProps } from '@mantine/core';
            ...
            (tableHeader ? (
               ...
               <div className="flex w-full items-center justify-between">
                  ...
                  <div className="flex gap-x-4">
                     ...
                     />
                     {onRefresh && (
                        <ActionIcon onClick={onRefresh} size={'lg'}>
                        ...
                        {_data.map((row, rowIndex) => (
                           <Table.Tr key={rowIndex}>
                              ...
                              {columns.map((column, columnIndex) => {
                                 const value = column.getValue ? column.getValue(row) : getObjValue(column.key as any, row);
